...
namespace Player
{
    public class Animation
    {
        ...
        public Animation(Texture2D texture, int framesX, float frameTime)
        {
            ...
            {
                _sourceRectangle.Add(new(i * frameWidth, 0, frameWidth, frameHeight));
            }
        }
        public void Stop()
        {
        ...
        {
            Globals.SpriteBatch.Draw(_texture, pos, _sourceRectangles[_frame], Color.White, 0, Vector.Zero, Vector2.Zero, Vector2.One, SpriteEffects.None, 1);
        }
    }
}*/
